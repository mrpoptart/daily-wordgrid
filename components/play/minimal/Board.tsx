        ...
        row.map((letter, colIndex) => {
          ...
          return (
            ...
            >
              {letter}
              {isFeedbackCell && (
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 -translate-y-full z-50 pointer-events-none pb-1">
                    {/* Content based on feedback.type */}
                    {feedback.type === 'success' && (
                       <div className="bg-white border border-gray-200 text-green-600 font-bold px-2 py-0.5 rounded-full shadow-lg text-sm flex items-center animate-in fade-in zoom-in slide-in-from-bottom-2 duration-300 whitespace-nowrap">
                           {feedback.message}
                       </div>
                    )}
                    {feedback.type === 'duplicate' && (
                        <div className="bg-green-500 rounded-full p-1 text-white shadow-lg animate-in fade-in zoom-in duration-200">
                    ...
                    {feedback.type === 'invalid' && (
                        <div className="bg-red-500 rounded-full p-1 text-white shadow-lg animate-in fade-in zoom-in duration-200">
                           <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="4" className="w-5 h-5">
